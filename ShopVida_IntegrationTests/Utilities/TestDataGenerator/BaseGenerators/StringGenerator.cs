namespace ShopVidaTests.Utilities.TestDataGenerator.BaseGenerators
{
	...
	public class StringGenerator : RandomGeneratorBase
	{
		...
		{
			return GenerateRandomStringOfLength(length, CharacterType.Alphabetic);
		}
