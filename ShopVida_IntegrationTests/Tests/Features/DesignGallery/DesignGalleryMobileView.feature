Feature: DesignGalleryMobileView
...
@Regression
Scenario Outline: Select a product to reuse design mobile view
	...
	Then Verify product card is shown for "Artwork1" with "<subCatagory>" subcategory
	And Remove the product from home page for "Artwork1" with "<subCatagory>" subcategory
	And Verify product card is not shown for "Artwork1" with "<subCatagory>" subcategory

	Examples:
		| category | product  | subCatagory |
		| bags     | Handbags | Tote Bag    |

@Regression
Scenario Outline: Promote a design mobile view
	Then Remove the product from home page for "Artwork1" with "<subCatagory>" subcategory
	When Add a "<category>" with "<product>" and "<subCatagory>"
	Then Verify product card is shown for "Artwork1" with "<subCatagory>" subcategory
	And Click on Promote for "Artwork1" with "<subCatagory>" subcategory
