...
Scenario Outline: Validate main menu navigation links
...
Scenario Outline: Verify main menu navigation links
	When I click "<menu>" and "<submenu>"
...
@Regression
Scenario Outline: Verify social media icons navigation
...
@Regression
Scenario Outline: Verify About list items navigation on lower footer
...
@Regression
Scenario Outline: Verify Privacy Policy navigation on lower footer
	When I click "<listItem>" lower footer link
	Then I navigated on page "<page>"
