...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("See production times page validation")]
        [NUnit.Framework.CategoryAttribute("Regression")]
        public virtual void SeeProductionTimesPageValidation()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("See production times page validation", null, new string[] {
                        "Regression"});
#line 34
this.ScenarioInitialize(scenarioInfo);
            this.ScenarioStart();
