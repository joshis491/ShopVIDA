Feature: ShoppingBagValidationMobileView
...
@Regression
Scenario: Perform checkout the product in shopping bag mobile view
...
@Regression
Scenario: Shopping bag checkout page validation mobile view
	Then Verify the validation messages for checkout page:
		| Country1      | GiftCardCode |
		| United States | Test         |

@Regression
Scenario: See production times page validation mobile view
	When I get Shopping Bag Payments data from file "ShoppingBagPayments.json"
	And I fill shopping bag checkout form information step
	And I Click Continue to shipping Button
	Then I'm on "shipping_method" payment page
...
@Regression
Scenario: Validate shopping bag checkout all steps navigation mobile view
	When I get Shopping Bag Payments data from file "ShoppingBagPayments.json"
	And I fill shopping bag checkout form information step
	And I Click Continue to shipping Button
	Then I'm on "shipping_method" payment page
...
@Ignore
@Regression
Scenario: Edit shopping bag checkout step name shipping mobile view
...
@Ignore
@Regression
Scenario: Edit shopping bag checkout step name payment mobile view
	Then Verify current active header tab should be "Information"
	When I get Shopping Bag Payments data from file "ShoppingBagPayments.json"
	And I fill shopping bag checkout form information step
	And I Click Continue to shipping Button
