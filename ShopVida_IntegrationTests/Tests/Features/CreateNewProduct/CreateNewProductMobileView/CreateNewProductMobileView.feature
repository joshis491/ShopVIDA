Feature: CreateNewProductMobileView
...
@OnlyForWindows
@Regression
Scenario: Upload a new artwork and delete it mobile view
...
@Regression
Scenario: Edit uploaded artwork mobile view
...
@Regression
Scenario: Product edit slider validation on upload artwork page mobile view
...
@Regression
Scenario: Products list checkboxes validation on Launch page mobile view
	When I select "Artwork1" artwork
