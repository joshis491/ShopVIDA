...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("apparel", "Tees", "Boatneck Boyfriend Tee", "Boatneck Knit Tee", null)]
...
#line 14
 testRunner.And(string.Format("Verify subcategory type below side bar header should be \"{0}\"", shopvidaProductType), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 15
...
#line 29
 testRunner.Then("Active navigation tab text should be \"SAMPLE\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 30
